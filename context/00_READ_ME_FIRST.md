...
- **コンテンツ**: 全 22 Mission の独り言・直接ヒントを起草済み（2026-09-13。Mission1〜3 は目視確定、4〜22 は実プレイでのトーン確認待ち。文言は `noir-api/app/content/missions.py` が正）
