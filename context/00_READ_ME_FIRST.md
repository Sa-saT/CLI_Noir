...
- 2026-09-13 に「セーブから再開すると進捗が逆戻りする」穴（push 済み commit に印を付けて resume 時にクリアを再適用）とクリア演出/独り言の重なりを修正済み（446 tests green）
