...
### Backend（`noir-api/`。2026-07-20 Phase2 完了・2026-09-12 統合ワールド Phase D 完了 — 532 tests green / ruff clean）
...
**疑似ターミナルの使用感（UX-01a, 2026-09-12 実施。532 tests green）**: 普段 CUI を使う人が不自然に思う挙動を実 bash に合わせた。
