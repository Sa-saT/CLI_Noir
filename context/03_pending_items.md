...
### Backend（`noir-api/`。2026-07-20 Phase2 完了・2026-09-12 統合ワールド Phase D 完了 — 551 tests green / ruff clean）
...
**疑似ターミナルの使用感（UX-01a, 2026-09-12 実施。551 tests green）**: 普段 CUI を使う人が不自然に思う挙動を実 bash に合わせた。
...
- [ ] ゲーム機能 12 項目のうち未実装: 8 リプレイ台帳（それ以外は 2026-09-13 までに実装）
